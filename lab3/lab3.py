...
btn_state_change = ttk.Button(root, text="Change\nthe state")
btn_state_change.place(x=100, y=220)

btn_join_stores = ttk.Button(root, text="Join\nstores")
btn_join_stores.place(x=190, y=220)
